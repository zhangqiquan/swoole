<?php
// +----------------------------------------------------------------------
// | zhanshop-swoole / Request类    [ 2021/10/22 4:52 下午 ]
// +-------------------------------------------------------------------------------------------------------
...
class Request
{
    ...
    public function __construct(){
        ...
        $inputData = $this->getInputData(file_get_contents('php://input'));
    ...
    {
        if (!in_array($type, ['param', 'get', 'post', 'put', 'patch', 'route', 'delete', 'env', 'request', 'server', 'header', 'file'])) {
            return false;
        }
     ...
     * @return void
     */
    public function setPost(mixed $key, mixed $value){
        $this->post[$key] = $value;
    }
     ...
     * @return void
     */
    public function setGet(mixed $key, mixed $value){
        $this->get[$key] = $value;
    }
