<?php
// +----------------------------------------------------------------------
// | zhanshop-swoole / SoftDelete.php    [ 2021/12/30 5:10 下午 ]
// +----------------------------------------------------------------------
...
trait SoftDelete
{
     ...
     * @return \think\model\concern\SoftDelete
     */
    ...
    {
        $field = property_exists($this, 'deleteTime') && isset($this->deleteTime) ? $this->deleteTime : false;
     ...
     * @return void
     */
    protected function withNoTrashed(mixed $query): void
    {
        $field = $this->getDeleteTimeField();
